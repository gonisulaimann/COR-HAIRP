...
import type { MapMarker, MapMarkersResponse } from "@/types";
    ...
    >
      <div className="flex items-start justify-between gap-2 mb-2">
        <div className="flex items-center gap-2">
          <span
            className={`h-2 w-2 rounded-full flex-shrink-0 ${RISK_DOT[marker.risk_level] || RISK_DOT.MODERATE}`}
          />
      ...
      <div className="flex items-center gap-4 text-xs text-surface-400">
        ...
        <div
          className={`flex items-center gap-1 font-semibold ${RISK_TEXT[marker.risk_level] || "text-surface-400"}`}
        >
  ...
  return (
    <div>
      ...
      <div className="mb-5 animate-fade-in">
        <h1 className="text-xl font-extrabold text-dark-text mb-1">
          Master Spatial Command Map
        </h1>
      ...
      <div className="flex gap-3 mb-4 flex-wrap animate-fade-in-down">
        {data.markers.map((m, i) => (
          ...
          >
            <span
              className={`h-[7px] w-[7px] rounded-full ${RISK_DOT[m.risk_level] || RISK_DOT.MODERATE}`}
            />
            <div>
              <p className="text-[0.78rem] font-bold text-dark-text">
                {m.name}
              </p>
